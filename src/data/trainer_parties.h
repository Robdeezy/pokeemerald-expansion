...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_PECK, MOVE_ASTONISH,MOVE_ASSURANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT, MOVE_PAY_DAY,MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATER_GUN, MOVE_HYPNOSIS,MOVE_POUND}
    }
};
...
static const struct TrainerMon sParty_GruntRusturfTunnel[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CONFUSION, MOVE_CONFUSE_RAY,MOVE_HEX}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PECK, MOVE_BITE,MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BITE, MOVE_ACID_SPRAY,MOVE_DISABLE}
    }
};
...
static const struct TrainerMon sParty_GruntMuseum1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUBBLE_BEAM,MOVE_EARTH_POWER,MOVE_HYPNOSIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 25,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRINE,MOVE_PSYBEAM,MOVE_POWER_GEM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 25,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_HYPNOSIS,MOVE_HEX,MOVE_ACID}
    }
};
...
static const struct TrainerMon sParty_GruntMuseum2[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUBBLE_BEAM,MOVE_AIR_SLASH,MOVE_PSYBEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 25,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_OCTAZOOKA,MOVE_AURORA_BEAM,MOVE_MUD_SHOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 25,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_HEX,MOVE_STRENGTH_SAP}
    }
};
...
static const struct TrainerMon sParty_Daisy[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT,MOVE_SWAGGER,MOVE_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_VENOSHOCK,MOVE_FLAMETHROWER,MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POISON_JAB,MOVE_SUCKER_PUNCH,MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMon sParty_Rose1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PETAL_BLIZZARD,MOVE_DAZZLING_GLEAM,MOVE_WISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAINING_KISS,MOVE_PSYBEAM,MOVE_LIFE_DEW}
    }
};
...
static const struct TrainerMon sParty_GabbyAndTy1[] = {
    ...
    .moves = {MOVE_MISTY_EXPLOSION,MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
...
static const struct TrainerMon sParty_Lola1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUBBLE_BEAM,MOVE_BOUNCE,MOVE_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUBBLE_BEAM,MOVE_DRAGON_BREATH,MOVE_TWISTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GIGA_DRAIN,MOVE_LEECH_SEED,MOVE_INGRAIN}
    }
};
...
static const struct TrainerMon sParty_Ricky1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_QUICK_ATTACK,MOVE_THUNDER_SHOCK,MOVE_PLUCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATER_PULSE,MOVE_WING_ATTACK,MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TOXIC,MOVE_COUNTER,MOVE_TAUNT}
    }
};
...
static const struct TrainerMon sParty_Simon[] = {
    ...
    .moves = {MOVE_SLASH,MOVE_SPORE,MOVE_ABSORB}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SLAM,MOVE_ROCK_TOMB,MOVE_MIMIC}
    }
};
...
static const struct TrainerMon sParty_Wilton1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MEGA_KICK,MOVE_BRAVE_BIRD,MOVE_THROAT_CHOP,MOVE_LOW_SWEEP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AURA_WHEEL,MOVE_THRASH,MOVE_CRUNCH,MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUG_BUZZ,MOVE_PSYCHIC,MOVE_ATTRACT,MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMon sParty_Brooke1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAMETHROWER,MOVE_DRAGON_PULSE,MOVE_SHELL_TRAP,MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SURF,MOVE_ICE_BEAM,MOVE_KNOCK_OFF,MOVE_AQUA_RING}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SLASH,MOVE_LEAF_BLADE,MOVE_X_SCISSOR,MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SNAP_TRAP,MOVE_STOMPING_TANTRUM,MOVE_ICE_FANG,MOVE_BOUNCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POISON_TAIL,MOVE_CRUNCH,MOVE_COIL,MOVE_GLARE}
    }
};
...
static const struct TrainerMon sParty_Cindy1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_DOUBLE_TEAM,MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_POUND, MOVE_DISARMING_VOICE,MOVE_SING}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_VINE_WHIP, MOVE_WRAP,MOVE_GROWTH}
    }
};
...
static const struct TrainerMon sParty_Winston1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SCRATCH, MOVE_MUD_SLAP, MOVE_ABSORB}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PAY_DAY, MOVE_BITE, MOVE_FAKE_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PAY_DAY, MOVE_METAL_CLAW, MOVE_HONE_CLAWS}
    },
...
static const struct TrainerMon sParty_Takao[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT,MOVE_QUICK_GUARD,MOVE_FORCE_PALM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PAYBACK,MOVE_FACADE,MOVE_TORMENT}
    }
};
...
static const struct TrainerMon sParty_Kirk[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_STICKY_WEB,MOVE_BUG_BITE,MOVE_ELECTRO_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHOCK_WAVE,MOVE_REVENGE,MOVE_BOUNCE}
    }
};
...
static const struct TrainerMon sParty_Shawn[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_WAVE,MOVE_THUNDERPUNCH,MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MUD_SHOT,MOVE_ZAP_CANNON,MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMon sParty_Dalton1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CROSS_POISON,MOVE_X_SCISSOR,MOVE_RAGE_POWDER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_POISON_JAB,MOVE_TAUNT}
    }
};
...
static const struct TrainerMon sParty_Larry[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_RAGING_BULL,MOVE_CLOSE_COMBAT,MOVE_ZEN_HEADBUTT,MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .moves = {MOVE_THRASH,MOVE_HIGH_HORSEPOWER,MOVE_HAMMER_ARM,MOVE_AVALANCHE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_FACADE,MOVE_THROAT_CHOP,MOVE_AERIAL_ACE,MOVE_TRAILBLAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GIGA_IMPACT,MOVE_BELLY_DRUM,MOVE_BRICK_BREAK,MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMon sParty_Travis[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_STICKY_WEB,MOVE_X_SCISSOR,MOVE_POISON_JAB,MOVE_DIG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_SLIDE,MOVE_IRON_HEAD,MOVE_THUNDER_FANG,MOVE_FIRE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ICICLE_CRASH,MOVE_AQUA_JET,MOVE_SUPERPOWER,MOVE_TRAILBLAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LEAF_BLADE,MOVE_AERIAL_ACE,MOVE_FOUL_PLAY,MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Derek[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_CRUNCH,MOVE_DRAGON_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AURORA_BEAM,MOVE_POWER_GEM,MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Edward[] = {
    ...
    .species = SPECIES_XATU,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AIR_SLASH,MOVE_TAILWIND,MOVE_PSYCHIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYBEAM,MOVE_MIMIC,MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DAZZLING_GLEAM,MOVE_PSYBEAM,MOVE_FREEZE_DRY}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYBEAM,MOVE_MYSTICAL_FIRE,MOVE_SWIFT}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_STONE_AXE,MOVE_QUICK_ATTACK,MOVE_FURY_CUTTER,MOVE_DOUBLE_HIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .moves = {MOVE_SMACK_DOWN,MOVE_FLAIL,MOVE_DISARMING_VOICE,MOVE_CONFUSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .moves = {MOVE_WATER_GUN,MOVE_FURY_CUTTER,MOVE_METAL_CLAW,MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .moves = {MOVE_MEGA_DRAIN,MOVE_ANCIENT_POWER,MOVE_INGRAIN,MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_VICE_GRIP,MOVE_ROCK_SMASH,MOVE_ROCK_TOMB,MOVE_HARDEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 16,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLOCK,MOVE_SPARK,MOVE_ROCK_TOMB,MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_PIN_MISSILE,MOVE_AERIAL_ACE,MOVE_ENDURE,MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_MACH_PUNCH,MOVE_SPORE,MOVE_LEECH_SEED,MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .species = SPECIES_TAUROS_PALDEAN_BLAZE_BREED,
    .moves = {MOVE_FLAME_CHARGE,MOVE_DOUBLE_KICK,MOVE_HEADBUTT,MOVE_WORK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .species = SPECIES_PAWMOT,
    .moves = {MOVE_NUZZLE,MOVE_DIG,MOVE_BITE,MOVE_SPARK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .species = SPECIES_POLIWRATH,
    .moves = {MOVE_DYNAMIC_PUNCH,MOVE_HYPNOSIS,MOVE_BODY_SLAM,MOVE_WATERFALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 23,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT,MOVE_WHIRLWIND,MOVE_BULK_UP,MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ZING_ZAP,MOVE_POISON_JAB,MOVE_BUBBLE_BEAM,MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SCALD,MOVE_DAZZLING_GLEAM,MOVE_THUNDERBOLT,MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLASH_CANNON,MOVE_THUNDERBOLT,MOVE_TRI_ATTACK,MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ACID_SPRAY,MOVE_BOOMBURST,MOVE_THUNDERBOLT,MOVE_SHIFT_GEAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ENERGY_BALL,MOVE_THUNDERBOLT,MOVE_CHARGE_BEAM,MOVE_SELF_DESTRUCT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .moves = {MOVE_THUNDERBOLT,MOVE_FLAMETHROWER,MOVE_ICE_FANG,MOVE_PSYCHIC_FANGS}
    }
};
...
static const struct TrainerMon sParty_Jerry1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUG_BITE,MOVE_METAL_CLAW,MOVE_AGILITY}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_SHOCK,MOVE_HEADBUTT,MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Karen1[] = {
    ...
    .species = SPECIES_SHROOMISH,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT,MOVE_STUN_SPORE,MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_VINE_WHIP,MOVE_GROWTH,MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MUD_SLAP,MOVE_POISON_POWDER,MOVE_MEGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    .species = SPECIES_SEEDOT,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MEGA_DRAIN,MOVE_GROWTH,MOVE_ROLLOUT}
    }
};
...
static const struct TrainerMon sParty_AnnaAndMeg1[] = {
    ...
    .species = SPECIES_DRIFBLIM,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PHANTOM_FORCE,MOVE_AIR_SLASH,MOVE_STRENGTH_SAP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHOCK_WAVE,MOVE_THUNDER_WAVE,MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_HEX,MOVE_WILL_O_WISP,MOVE_DISABLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHADOW_SNEAK,MOVE_KNOCK_OFF,MOVE_TAUNT}
    }
};
...
static const struct TrainerMon sParty_Victor[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DUAL_WINGBEAT,MOVE_QUICK_ATTACK,MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SLASH,MOVE_PIN_MISSILE,MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Miguel1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ASTONISH,MOVE_POUNCE,MOVE_WITHDRAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_PULSE,MOVE_APPLE_ACID,MOVE_STOMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_PULSE,MOVE_GRAV_APPLE,MOVE_ACROBATICS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SYRUP_BOMB,MOVE_DRAGON_PULSE,MOVE_RECOVER}
    }
};
...
static const struct TrainerMon sParty_Victoria[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SLUDGE_BOMB,MOVE_MAGICAL_LEAF,MOVE_TOXIC}
    }
};
...
static const struct TrainerMon sParty_Isabel1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_WAVE,MOVE_DISCHARGE,MOVE_SWIFT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 26,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DISCHARGE,MOVE_NASTY_PLOT,MOVE_PSYCHIC}
    }
};
...
static const struct TrainerMon sParty_Vicky[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_HIGH_JUMP_KICK}
    }
};
...
static const struct TrainerMon sParty_Calvin1[] = {
    ...
    .species = SPECIES_POOCHYENA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_TACKLE, MOVE_BITE, MOVE_SAND_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 7,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_TACKLE, MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_TOMB,MOVE_FLAME_WHEEL,MOVE_HOWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_THROW,MOVE_PAYBACK,MOVE_STOMPING_TANTRUM}
    }
};
...
static const struct TrainerMon sParty_Tommy[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ACID_SPRAY,MOVE_ANCIENT_POWER,MOVE_SMACK_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_THROW,MOVE_DOUBLE_TEAM,MOVE_ROAR}
    }
};
...
static const struct TrainerMon sParty_Joey[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_LOW_KICK,MOVE_LEER,MOVE_REVENGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_SMASH,MOVE_FAKE_OUT,MOVE_FOCUS_ENERGY}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_VICE_GRIP,MOVE_ROCK_SMASH,MOVE_BUBBLE_BEAM}
    }
};
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDERBOLT,MOVE_LOW_KICK,MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PARABOLIC_CHARGE,MOVE_VOLT_SWITCH,MOVE_BOOMBURST}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUG_BUZZ,MOVE_DISCHARGE,MOVE_FLY}
    }
};
...
static const struct TrainerMon sParty_Jaylen[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_EARTHQUAKE,MOVE_DRAGON_TAIL,MOVE_STONE_EDGE,MOVE_HEAT_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ZEN_HEADBUTT,MOVE_METEOR_MASH,MOVE_BULLET_PUNCH,MOVE_MAGNET_RISE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_SHELGON,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PROTECT,MOVE_DOUBLE_EDGE,MOVE_OUTRAGE,MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_CLAW,MOVE_CLOSE_COMBAT,MOVE_ROCK_SLIDE,MOVE_DRAGON_DANCE}
    }
};
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_FAIRY_WIND, MOVE_SAND_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 8,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_BITE, MOVE_WORK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 8,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PECK, MOVE_PSYWAVE, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Timmy[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_NIGHT_SLASH,MOVE_HEADBUTT,MOVE_LICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FACADE,MOVE_PSYCHIC_FANGS,MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FIRE_FANG,MOVE_ICE_FANG,MOVE_THUNDER_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROLLOUT,MOVE_AQUA_JET,MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_Andrew[] = {
    ...
    .species = SPECIES_SPOINK,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYSHOCK,MOVE_POWER_GEM,MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AQUA_JET,MOVE_ICE_FANG,MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHADOW_BONE,MOVE_FLAME_WHEEL,MOVE_BONEMERANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    .species = SPECIES_RAICHU_ALOLAN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDERBOLT,MOVE_PSYCHIC,MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMon sParty_Ivan[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WATER_GUN,MOVE_YAWN,MOVE_CONFUSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT,MOVE_ICY_WIND,MOVE_GROWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ICE_SHARD,MOVE_WATER_GUN,MOVE_WITHDRAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    .species = SPECIES_CLAMPERL,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WATER_GUN,MOVE_WHIRLPOOL,MOVE_IRON_DEFENSE}
    }
};
...
static const struct TrainerMon sParty_Elliot1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FELL_STINGER, MOVE_POISON_JAB, MOVE_SPIKES}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    .species = SPECIES_SLOWPOKE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CONFUSION, MOVE_WATER_PULSE, MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_YAWN, MOVE_DISABLE}
    }
};
...
static const struct TrainerMon sParty_Ned[] = {
    ...
    .species = SPECIES_TENTACOOL,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUBBLEBEAM, MOVE_ACID, MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POISON_TAIL, MOVE_WATER_PULSE, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRINE, MOVE_BARB_BARRAGE, MOVE_FELL_STINGER}
    }
...
static const struct TrainerMon sParty_Dale[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRILL_PECK,MOVE_DRILL_RUN,MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AIR_CUTTER,MOVE_BUBBLE_BEAM,MOVE_SIGNAL_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_CLAW,MOVE_DRAGON_RAGE,MOVE_BULLDOZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LIQUIDATION,MOVE_ICE_FANG,MOVE_AQUA_JET}
    }
};
...
static const struct TrainerMon sParty_Wade[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SCALD,MOVE_ICY_WIND,MOVE_LOW_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LIQUIDATION,MOVE_CRUNCH,MOVE_PECK}
    }
};
...
static const struct TrainerMon sParty_Jacob[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK,MOVE_ENDEAVOR,MOVE_BONE_RUSH,MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHADOW_BALL,MOVE_HYPNOSIS,MOVE_CURSE,MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DUAL_WINGBEAT,MOVE_QUICK_ATTACK,MOVE_X_SCISSOR,MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ICICLE_CRASH,MOVE_THRASH,MOVE_HAMMER_ARM,MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BLAZE_KICK,MOVE_AERIAL_ACE,MOVE_BRICK_BREAK,MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Anthony[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POWER_SPLIT,MOVE_ROCK_THROW,MOVE_BUG_BITE,MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    .species = SPECIES_PYUKUMUKU,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TAUNT,MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_SWAGGER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FELL_STINGER,MOVE_DOUBLE_EDGE,MOVE_X_SCISSOR,MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LAVA_PLUME,MOVE_BODY_SLAM,MOVE_SMOKESCREEN,MOVE_RAPID_SPIN}
    }
...
static const struct TrainerMon sParty_Benjamin1[] = {
    ...
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CRUNCH,MOVE_IRON_HEAD,MOVE_ROCK_SLIDE,MOVE_DIG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BODY_SLAM,MOVE_AVALANCHE,MOVE_CRUNCH,MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 35,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ICICLE_SPEAR,MOVE_ICE_SHARD,MOVE_SPIKE_CANNON,MOVE_ROCK_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHADOW_SNEAK,MOVE_NIGHT_SLASH,MOVE_IRON_HEAD,MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_Abigail1[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_U_TURN,MOVE_GIGA_DRAIN,MOVE_ACID_SPRAY,MOVE_STRUGGLE_BUG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ELECTRO_BALL,MOVE_CHARGE_BEAM,MOVE_GRASS_KNOT,MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_U_TURN,MOVE_BUG_BITE,MOVE_ACROBATICS,MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    .species = SPECIES_BARRASKEWDA,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AQUA_JET,MOVE_FLIP_TURN,MOVE_THROAT_CHOP,MOVE_ICE_FANG}
    }
};
...
static const struct TrainerMon sParty_Jasmine[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MOONBLAST,MOVE_SUNNY_DAY,MOVE_SOLAR_BEAM,MOVE_SYNTHESIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TRI_ATTACK,MOVE_MAGNET_RISE,MOVE_POWER_GEM,MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BLOCK,MOVE_ANCIENT_POWER,MOVE_IRON_DEFENSE,MOVE_HEAVY_SLAM}
    }
};
...
static const struct TrainerMon sParty_Dylan1[] = {
    ...
    .species = SPECIES_GOLBAT,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BITE,MOVE_AIR_SLASH,MOVE_POISON_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BEAK_BLAST,MOVE_SUPERSONIC,MOVE_ROCK_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DIVE,MOVE_DRILL_PECK,MOVE_THRASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DUAL_WINGBEAT,MOVE_KNOCK_OFF,MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_Maria1[] = {
    ...
    .species = SPECIES_MAWILE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_IRON_HEAD,MOVE_PLAY_ROUGH,MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MOONBLAST,MOVE_PSYCHIC,MOVE_CALM_MIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PLAY_ROUGH,MOVE_ENERGY_BALL,MOVE_WISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PLAY_ROUGH,MOVE_CRUNCH,MOVE_DOUBLE_EDGE}
    }
};
...
static const struct TrainerMon sParty_Lung[] = {
    ...
    .species = SPECIES_MASQUERAIN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AIR_CUTTER,MOVE_BUG_BUZZ,MOVE_GIGA_DRAIN,MOVE_HYDRO_PUMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SKITTER_SMACK,MOVE_POWER_GEM,MOVE_ACROBATICS,MOVE_ROOST}
    }
};
...
static const struct TrainerMon sParty_Jocelyn[] = {
    ...
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ZEN_HEADBUTT,MOVE_HIGH_JUMP_KICK,MOVE_FORCE_PALM}
    }
};
...
static const struct TrainerMon sParty_Laura[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CROSS_CHOP,MOVE_SEISMIC_TOSS,MOVE_SWAGGER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_LEEK,
    .moves = {MOVE_BRUTAL_SWING,MOVE_ROCK_SMASH,MOVE_LEAF_BLADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_METAL_CLAW,MOVE_POISON_JAB,MOVE_ROCK_SMASH}
    }
};
...
static const struct TrainerMon sParty_Carol[] = {
    ...
    .species = SPECIES_FEAROW,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRILL_PECK,MOVE_DRILL_RUN,MOVE_STEEL_WING,MOVE_PLUCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WOOD_HAMMER,MOVE_DESTINY_BOND,MOVE_HEX,MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_STONE_EDGE,MOVE_HEAVY_SLAM,MOVE_BODY_SLAM,MOVE_ROCK_POLISH}
    }
};
...
static const struct TrainerMon sParty_Irene[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_SEED_BOMB,MOVE_MACH_PUNCH,MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDERBOLT,MOVE_SCALD,MOVE_THUNDER_WAVE,MOVE_ICY_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LOW_KICK,MOVE_FLAMETHROWER,MOVE_SCORCHING_SANDS,MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_HELIOLISK,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PARABOLIC_CHARGE,MOVE_THUNDERBOLT,MOVE_BREAKING_SWIPE,MOVE_SURF}
    }
};
...
static const struct TrainerMon sParty_AmyAndLiv1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_SLIDE,MOVE_IRON_HEAD,MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BUG_BITE,MOVE_SUCKER_PUNCH,MOVE_CONFUSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_SHOCK,MOVE_GEAR_GRIND,MOVE_VISE_GRIP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DIG,MOVE_BULLDOZE,MOVE_SUCKER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_GinaAndMia1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_QUICK_ATTACK,MOVE_THUNDER_SHOCK,MOVE_CHARM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_NUZZLE,MOVE_PARABOLIC_CHARGE,MOVE_TAIL_WHIP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_NUZZLE,MOVE_SPARK,MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK,MOVE_ROLLOUT,MOVE_DEFENSE_CURL}
    }
};
...
static const struct TrainerMon sParty_Huey[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SEED_BOMB,MOVE_SLEEP_POWDER,MOVE_SYNTHESIS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAMETHROWER,MOVE_DRAGON_BREATH,MOVE_METAL_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATER_PULSE,MOVE_ICY_WIND,MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Edmond[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRUTAL_SWING,MOVE_BULLDOZE,MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BULLDOZE,MOVE_MEGA_DRAIN,MOVE_SAND_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AQUA_TAIL,MOVE_MUD_SHOT,MOVE_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POISON_TAIL,MOVE_MUD_SHOT,MOVE_YAWN}
    }
};
...
static const struct TrainerMon sParty_Dwayne[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AURORA_BEAM,MOVE_EXTRASENSORY,MOVE_ICE_SHARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAIL,MOVE_MUD_BOMB,MOVE_ICE_SHARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRILL_PECK,MOVE_WATER_PULSE,MOVE_PRESENT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CONFUSION,MOVE_AURORA_BEAM,MOVE_LICK}
    }
};
...
static const struct TrainerMon sParty_Edwin1[] = {
    ...
    .species = SPECIES_LOMBRE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT,MOVE_MEGA_DRAIN,MOVE_BUBBLE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_NUZLEAF,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_RAZOR_LEAF,MOVE_PAYBACK,MOVE_AIR_CUTTER}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Mudkip[] = {
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SLASH,MOVE_THROAT_CHOP,MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DISCHARGE,MOVE_AIR_SLASH,MOVE_UPROAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAMETHROWER,MOVE_PSYSHOCK,MOVE_NIGHT_SHADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CRABHAMMER,MOVE_HAMMER_ARM,MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GIGA_DRAIN,MOVE_DRAGON_BREATH,MOVE_VACUUM_WAVE}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Treecko[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ACROBATICS,MOVE_SLEEP_POWDER,MOVE_DRAINING_KISS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BLAZE_KICK,MOVE_BOUNCE,MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute110Torchic[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATERFALL,MOVE_BULLDOZE,MOVE_AVALANCHE}
    }
};
...
static const struct TrainerMon sParty_Isaac1[] = {
    ...
    .species = SPECIES_FLAMIGO,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MEGA_KICK,MOVE_DUAL_WINGBEAT,MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PURSUIT,MOVE_DRILL_PECK,MOVE_HONE_CLAWS}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAME_CHARGE,MOVE_ACROBATICS,MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Lydia1[] = {
    ...
    .species = SPECIES_KADABRA,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYSHOCK,MOVE_DISABLE,MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_HYPER_FANG,MOVE_CRUNCH,MOVE_PURSUIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SMACK_DOWN,MOVE_ACCELEROCK,MOVE_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ACID_SPRAY,MOVE_DRAGON_BREATH,MOVE_WATER_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_NO_RETREAT,MOVE_FIRST_IMPRESSION,MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Brenden[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAME_CHARGE,MOVE_ARM_THRUST,MOVE_ROLLOUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 22,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SLAM,MOVE_ROCK_SLIDE,MOVE_DYNAMIC_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 22,
    .species = SPECIES_HAKAMO_O,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_TAIL,MOVE_HEADBUTT,MOVE_LOW_KICK}
    }
};
...
static const struct TrainerMon sParty_Lilith[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRUTAL_SWING,MOVE_STRENGTH,MOVE_BABY_DOLL_EYES}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ARM_THRUST,MOVE_CIRCLE_THROW,MOVE_WORK_UP}
    }
};
...
static const struct TrainerMon sParty_Cristian[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT,MOVE_TRIPLE_KICK,MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_BLAZE_KICK,MOVE_ENDURE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
...
static const struct TrainerMon sParty_BrendanRustboroTreecko[] = {
    ...
    .species = SPECIES_CUBONE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BONE_CLUB, MOVE_BONEMERANG,MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 21,
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AQUA_TAIL, MOVE_BOUNCE,MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_COTTON_SPORE, MOVE_LEAF_TORNADO,MOVE_ROUND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 22,
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AERIAL_ACE, MOVE_SLASH,MOVE_FLAME_CHARGE}
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroMudkip[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WILL_O_WISP, MOVE_INCINERATE,MOVE_NIGHT_SHADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 21,
    ...
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLAM,MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_BrendanRustboroTorchic[] = {
    ...
    .species = SPECIES_MARSHTOMP,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_THROW, MOVE_LIQUIDATION,MOVE_ROCK_SMASH}
    }
};
...
static const struct TrainerMon sParty_Haley1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_POUND,MOVE_CHARM,MOVE_BULLET_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT,MOVE_BABY_DOLL_EYES,MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SUPER_FANG,MOVE_DOUBLE_HIT,MOVE_ENCORE}
    }
};
...
static const struct TrainerMon sParty_Janice[] = {
    ...
    .species = SPECIES_NATU,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PECK,MOVE_CONFUSE_RAY,MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_UPROAR,MOVE_YAWN,MOVE_EXTRASENSORY}
    }
};
...
static const struct TrainerMon sParty_Vivi[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TOXIC_SPIKES,MOVE_SPIKY_SHIELD,MOVE_PETAL_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_INCINERATE,MOVE_BUG_BITE,MOVE_FIRE_LASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WAVE_CRASH,MOVE_HEAD_SMASH,MOVE_TAKE_DOWN}
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BUG_BITE, MOVE_POISON_STING, MOVE_STRING_SHOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 8,
...
static const struct TrainerMon sParty_Lyle[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BUG_BITE, MOVE_TACKLE,MOVE_RAPID_SPIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_POISON_STING, MOVE_ROLLOUT,MOVE_DEFENSE_CURL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_STRUGGLE_BUG, MOVE_CONFUSE_RAY,MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_STRUGGLE_BUG, MOVE_CHARM,MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Jose[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FURY_CUTTER,MOVE_ABSORB,MOVE_GROWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WATER_GUN,MOVE_INFESTATION,MOVE_BUG_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_STRUGGLE_BUG,MOVE_ASSURANCE,MOVE_ASTONISH}
    }
};
...
static const struct TrainerMon sParty_James1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_STICKY_WEB, MOVE_STRUGGLE_BUG,MOVE_ASSURANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EMBER, MOVE_BITE,MOVE_TAUNT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 12,
    .species = SPECIES_NINCADA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SCRATCH, MOVE_BUG_BITE,MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMon sParty_Brice[] = {
    ...
    .moves = {MOVE_LAVA_PLUME,MOVE_POWER_GEM,MOVE_SCORCHING_SANDS,MOVE_SHELL_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATERFALL,MOVE_ICE_SPINNER,MOVE_HEAD_SMASH,MOVE_BELLY_DRUM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SUPERPOWER,MOVE_PSYCHO_CUT,MOVE_FOUL_PLAY,MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAMETHROWER,MOVE_SEED_BOMB,MOVE_ZEN_HEADBUTT,MOVE_TRAILBLAZE}
    }
};
...
static const struct TrainerMon sParty_Trent1[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRILL_PECK,MOVE_PAYBACK,MOVE_STEEL_WING,MOVE_SPIKES}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_FIRE_PUNCH,MOVE_ICE_PUNCH,MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_HEAD_SMASH,MOVE_WAVE_CRASH,MOVE_DOUBLE_EDGE,MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMon sParty_Clark[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROLLOUT,MOVE_BULLDOZE,MOVE_ROCK_THROW}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROLLOUT,MOVE_SPARK,MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMon sParty_Johanna[] = {
    ...
    .species = SPECIES_GOLDEEN,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HORN_ATTACK,MOVE_WATER_PULSE,MOVE_AQUA_RING}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FACADE,MOVE_PLAY_ROUGH,MOVE_COPYCAT}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_PUNCH,MOVE_ROCK_THROW,MOVE_SELF_DESTRUCT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DRAGON_PULSE,MOVE_ELECTRO_BALL,MOVE_POWER_GEM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FLAME_CHARGE,MOVE_STOMP,MOVE_WILD_CHARGE}
    }
};
...
static const struct TrainerMon sParty_WallyMauville[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SACRED_SWORD,MOVE_SLASH,MOVE_PSYCHO_CUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYCHIC,MOVE_MOONBLAST,MOVE_UPROAR}
    }
};
...
static const struct TrainerMon sParty_Dawson[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TWINEEDLE,MOVE_PURSUIT,MOVE_RAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GUST,MOVE_SLEEP_POWDER,MOVE_PSYBEAM}
    }
};
...
static const struct TrainerMon sParty_Sarah[] = {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_THUNDER_WAVE,MOVE_IRON_TAIL,MOVE_THUNDER_SHOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 20,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BITE,MOVE_SAND_ATTACK,MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Darian[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_WATER_GUN, MOVE_METAL_CLAW,MOVE_TACKLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    .species = SPECIES_CORPHISH,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_KNOCK_OFF,MOVE_DOUBLE_HIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 11,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ROCK_SMASH, MOVE_BIND,MOVE_LEER}
    }
...
static const struct TrainerMon sParty_Hailey[] = {
    ...
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SMACK_DOWN,MOVE_BULLDOZE,MOVE_STOMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FAKE_OUT,MOVE_SUCKER_PUNCH,MOVE_FLATTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 18,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MAGICAL_LEAF,MOVE_CONFUSION,MOVE_SAFEGUARD}
    }
};
...
static const struct TrainerMon sParty_Chandler[] = {
    ...
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_THROW,MOVE_ANCIENT_POWER,MOVE_INCINERATE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PIN_MISSILE,MOVE_RECOVER,MOVE_CHILLING_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 21,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_VINE_WHIP,MOVE_MEGA_DRAIN}
    }
};
...
static const struct TrainerMon sParty_Kaleb[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DISCHARGE,MOVE_NASTY_PLOT,MOVE_SWEET_KISS}
    }
};
...
static const struct TrainerMon sParty_Joseph[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DISCHARGE,MOVE_FIRE_FANG,MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WILD_CHARGE,MOVE_ICE_FANG,MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_Alyssa[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_REFLECT,MOVE_LIGHT_SCREEN,MOVE_SEISMIC_TOSS,MOVE_SOFT_BOILED}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    .species = SPECIES_WOBBUFFET,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_COUNTER,MOVE_MIRROR_COAT,MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_AQUA_RING,MOVE_WISH,MOVE_SCALD,MOVE_WHIRLPOOL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 36,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BODY_SLAM,MOVE_CURSE,MOVE_REST,MOVE_YAWN}
    }
};
...
static const struct TrainerMon sParty_Marcos[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CHARGE_BEAM,MOVE_SWIFT,MOVE_SELF_DESTRUCT}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_CHARGE_BEAM,MOVE_ENERGY_BALL,MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMon sParty_Rhett[] = {
    ...
    .species = SPECIES_SAWK,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DOUBLE_KICK,MOVE_BULK_UP,MOVE_STRENGTH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_VITAL_THROW,MOVE_CIRCLE_THROW,MOVE_REVERSAL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 27,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_DOUBLE_EDGE,MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Tyron[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PSYCHIC_TERRAIN,MOVE_PSYBEAM,MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_EARTH_POWER,MOVE_SLUDGE_WAVE,MOVE_ICY_WIND}
    }
};
...
static const struct TrainerMon sParty_Celina[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_EARTH_POWER,MOVE_SLUDGE_WAVE,MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMon sParty_Bianca[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BRICK_BREAK,MOVE_POISON_JAB,MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_VILEPLUME,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PETAL_DANCE,MOVE_MOONBLAST,MOVE_SLUDGE_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_BELLOSSOM,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PETAL_BLIZZARD,MOVE_MOONBLAST,MOVE_TRIPLE_AXEL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_NIGHT_SLASH,MOVE_SUCKER_PUNCH,MOVE_HONE_CLAWS}
    }
};
...
static const struct TrainerMon sParty_Hayden[] = {
    ...
    .species = SPECIES_PINSIR,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_VICE_GRIP,MOVE_X_SCISSOR,MOVE_SUBMISSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_SANDSLASH,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BULLDOZE,MOVE_ROLLOUT,MOVE_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ICICLE_CRASH,MOVE_METAL_CLAW,MOVE_HONE_CLAWS}
    }
};
...
static const struct TrainerMon sParty_Lawrence[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATERFALL,MOVE_MEGAHORN,MOVE_ICY_WIND,MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_EARTHQUAKE,MOVE_SHADOW_BONE,MOVE_ICY_WIND,MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMon sParty_Wyatt[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_EARTHQUAKE,MOVE_CRUNCH,MOVE_STONE_EDGE,MOVE_SANDSTORM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    .species = SPECIES_LAIRON,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_IRON_TAIL,MOVE_ROCK_SLIDE,MOVE_SHADOW_CLAW,MOVE_METAL_BURST}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_HEAD_SMASH,MOVE_ZEN_HEADBUTT,MOVE_TRAILBLAZE,MOVE_AVALANCHE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ROCK_WRECKER,MOVE_X_SCISSOR,MOVE_STOMPING_TANTRUM,MOVE_SHELL_SMASH}
    }
};
...
static const struct TrainerMon sParty_Deandre[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_GRASS_PLEDGE,MOVE_IRON_TAIL,MOVE_LOW_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_WATER_PLEDGE,MOVE_ICE_BEAM,MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_FIRE_PLEDGE,MOVE_ACROBATICS,MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMon sParty_Bryant[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_EARTHQUAKE,MOVE_ICE_SHARD}
    }
};
...
static const struct TrainerMon sParty_Shayla[] = {
    ...
    .species = SPECIES_KILOWATTREL,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DISCHARGE,MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
...
static const struct TrainerMon sParty_Devan[] = {
    ...
    .species = SPECIES_SANDSHREW,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FURY_CUTTER,MOVE_BULLDOZE,MOVE_POISON_STING}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FURY_CUTTER,MOVE_POWDER_SNOW,MOVE_METAL_CLAW}
    }
};
...
static const struct TrainerMon sParty_Johnson[] = {
    ...
    .species = SPECIES_LOTAD,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MEGA_DRAIN,MOVE_FLAIL,MOVE_BUBBLE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 14,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FURY_CUTTER,MOVE_RAZOR_LEAF,MOVE_INGRAIN}
    }
};
...
static const struct TrainerMon sParty_Melina[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_BULLDOZE,MOVE_IRON_HEAD,MOVE_SHED_TAIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    .species = SPECIES_STUNFISK_GALARIAN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_METAL_CLAW,MOVE_MUD_SHOT,MOVE_SNAP_TRAP}
    }
};
...
static const struct TrainerMon sParty_Brandi[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_AQUA_JET,MOVE_LEECH_LIFE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ANCIENT_POWER,MOVE_BRINE,MOVE_MUD_SHOT}
    }
};
...
static const struct TrainerMon sParty_Aisha[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DIG,MOVE_CRUNCH,MOVE_TAKE_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 28,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SHADOW_PUNCH,MOVE_STOMPING_TANTRUM,MOVE_MEGA_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_NUZZLE,MOVE_HEADBUTT,MOVE_SWAGGER}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
    .species = SPECIES_MORPEKO,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_NUZZLE,MOVE_SWAGGER,MOVE_AURA_WHEEL}
    }
};
