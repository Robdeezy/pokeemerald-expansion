...
static const u16 sPrizeListRoar[]        = {ITEM_TM_PLAY_ROUGH,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListToxic[]       = {ITEM_TM_THUNDER_FANG,  ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSunnyDay[]    = {ITEM_TM_HYPER_VOICE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListBrickBreak[]  = {ITEM_TM_AURA_SPHERE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListTorment[]     = {ITEM_TM_NIGHT_SLASH,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListSkillSwap[]   = {ITEM_TM_BUG_BUZZ,    ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListAttract[]     = {ITEM_TM_METAL_CLAW,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static u16 GetPrizeItemId(void)
{
    ...
    // - ITEM_TM_HYPER_VOICE     (Normal)
    // - ITEM_ELIXIR           (Variety)
    // - ITEM_TM_GIGA_DRAIN    (Unique)
    // - ITEM_TM_AURA_SPHERE   (Expert)
