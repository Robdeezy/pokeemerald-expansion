...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(50, 50, 50, 50),
        .minYield = YIELD_RATE(25, 25, 25, 25),
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(30, 30, 30, 30),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(150, 150, 150, 150),
        .minYield = YIELD_RATE(100, 100, 100, 100),
    ...
    [ITEM_OCCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 90,
        .maxYield = YIELD_RATE(15, 15, 15, 15),
